...
<a href="https://x.com/Marvvanee"><img src="https://img.shields.io/badge/X%20(Twitter)-Follow-000000?style=for-the-badge&logo=x&logoColor=white" /></a>
<a href="https://www.instagram.com/m.arvvanee/"><img src="https://img.shields.io/badge/Instagram-m.arvvanee-E4405F?style=for-the-badge&logo=instagram&logoColor=white" /></a>
...
```json
{
  ...
  "education"  : "Web Dev Diploma @ ISTA (2024–2026)",
  "languages"  : ["Arabic 🇲🇦","French 🇫🇷","English 🇬🇧"],
  "focus"      : ["React","Laravel","UI/UX","APIs"],
  "available"  : true,
  "motto"      : "Shaping the digital future."
}
```
...
$ traits --list
  ...
  ⚡  Fast Learner
      Always ship with latest tech

  🎯  Detail Oriented
      Pixel-perfect. Zero compromise.

  🤝  Team Player
      Agile. Collaborative. Reliable.

  🔒  ISC² Certified
      Core Cybersecurity Principles

  🌐  17 Public Repositories
      Across React, PHP, Python & more
```
...
### 🌾 Cooperative Market
> Agricultural management platform — built during internship @ ORMVAO

- 📊 Real-time data visualization dashboard
- 🌱 Crop tracking & inventory management
- 🖥️ Responsive admin panel from design to deployment
- 🤝 Built in Agile team environment

**Stack:** `React` `Laravel` `MySQL` `JavaScript`

[![Repo](https://img.shields.io/badge/Source_Code-181717?style=flat-square&logo=github)](https://github.com/marouaneradi/Cooperative_Market)
[![Live](https://img.shields.io/badge/Live_Demo-00D9FF?style=flat-square&logo=vercel&logoColor=black)](https://cooprativemarket.vercel.app/)
...
### 🌦 Nimbus — Weather App
> Live weather data for any city on Earth

- 🌡️ Real-time temp, humidity & wind via OpenWeatherMap API
- 🌍 Worldwide city search with instant results
- 🎨 Dynamic UI that reacts to weather conditions
- ⚡ Lightning-fast with Vite

**Stack:** `React` `Vite` `OpenWeatherMap API` `CSS3`

[![Repo](https://img.shields.io/badge/Source_Code-181717?style=flat-square&logo=github)](https://github.com/marouaneradi/React-weather-app-with-Vite-and-OpenWeather-API)
[![Live](https://img.shields.io/badge/Live_Demo-00D9FF?style=flat-square&logo=vercel&logoColor=black)](https://nimbus-sage-ten.vercel.app/)
...
### 🎬 CineFind — Movie Search
> Cinematic discovery powered by OMDb API

- 🔍 Real-time search with type filtering
- 📄 Full detail pages — ratings, cast, box office
- 📑 Paginated results for smooth browsing
- ⚛️ SPA architecture with React Router

**Stack:** `React` `Vite` `React Router` `OMDb API`

[![Repo](https://img.shields.io/badge/Source_Code-181717?style=flat-square&logo=github)](https://github.com/marouaneradi/movie-search-app)
[![Live](https://img.shields.io/badge/Live_Demo-00D9FF?style=flat-square&logo=vercel&logoColor=black)](https://movie-search-app-ten-kappa.vercel.app/)

</td>

<td width="50%" valign="top">

### ⬡ GitFinder — Profile Search
> Instant GitHub profile lookup tool

- 👤 Search any developer by username instantly
- 📁 View repos, followers, following & account info
- 🔗 Direct links to each repository
- 🧼 Clean & minimal UI

**Stack:** `React` `Vite` `GitHub API` `CSS`

[![Repo](https://img.shields.io/badge/Source_Code-181717?style=flat-square&logo=github)](https://github.com/marouaneradi/github-profile-finder)
[![Live](https://img.shields.io/badge/Live_Demo-00D9FF?style=flat-square&logo=vercel&logoColor=black)](https://github-profile-finder-three-rho.vercel.app/)
...
[![View All Repositories](https://img.shields.io/badge/📁%20View%20All%2017%20Repositories-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/marouaneradi?tab=repositories)
...
```bash
$ marouane --current-focus

  [2024 → 2026]  📚  Completing Web Development Diploma @ ISTA Ouarzazate
  [Active]       ⚛️   Deepening React ecosystem — hooks, context, patterns
  [Active]       🏗️   Advancing Laravel — APIs, auth, architecture
  [Exploring]    🎨   UI/UX principles and design systems
  [Exploring]    🧪   Unit testing in React (Jest + Testing Library)
  [Open]         💼   Full-time roles · Freelance projects · Collabs
...
> *I'm open to full-time roles, freelance projects, and ambitious collaborations.*
> *If you have an idea — I have the skills to bring it to life.*

<br/>

[![Email](https://img.shields.io/badge/📩%20radimarouane05@gmail.com-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:radimarouane05@gmail.com)

[![LinkedIn](https://img.shields.io/badge/💼%20Connect%20on%20LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/marouaneradi)
[![Portfolio](https://img.shields.io/badge/🌐%20marouaneweb.vercel.app-00D9FF?style=for-the-badge&logo=vercel&logoColor=black)](https://marouaneweb.vercel.app/)
[![X](https://img.shields.io/badge/𝕏%20@Marvvanee-000000?style=for-the-badge&logo=x&logoColor=white)](https://x.com/Marvvanee)
[![Instagram](https://img.shields.io/badge/📸%20m.arvvanee-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://www.instagram.com/m.arvvanee/)

<br/>

📍 Ouarzazate, Morocco &nbsp;·&nbsp; 📱 +212 704 460 903
...
*Designed & Built with 🤍 by Marouane Radi · © 2026 · All rights reserved.*
